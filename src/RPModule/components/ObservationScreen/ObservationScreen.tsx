...
interface ObservationScreenProps  extends RouteComponentProps
{
   singleObservationDetails:any
}
class ObservationScreen extends Component<ObservationScreenProps> {
   ...
   render() {
      const {
         ...
         value,
         isRoleType
      } = this.props.singleObservationDetails
      console.log(this.props.singleObservationDetails)
