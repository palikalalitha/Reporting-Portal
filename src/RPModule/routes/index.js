...
import {RP_PATH,RP_CREATION_FORM,OBSERVATION_SCREEN,Assigned_OBSERVATIONS_PATH,OBSERVATION_LIST} from "../constants/RPRouteConstants/RPRouteConstants"
import UserFormRoute from "../../UserModule/routes/UserFormRoute/UserFormRoute"
import ObservationScreenRoute from "../../UserModule/routes/ObservationScreenRoute"
...
const routes = [
   ...
   <Route path={Assigned_OBSERVATIONS_PATH} component={RPAssignedObservationsRoute}/>,
