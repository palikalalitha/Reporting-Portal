...
class ObservationScreenRoute extends React.Component {
   ...
   renderSuccessUI= observer(() => {
      const {getSingleObservationDetails,getObservationDetailsAPIError,getObservationDetailsAPIStatus}=this.props.userStore
      const {
         title,
         description,
         priority,
  ...
  return( <ObservationScreen
   ...
   render() {
      const {getObservationDetailsAPIError,getObservationDetailsAPIStatus}=this.props.userStore
